...
Elm.Layout.make = function (_elm) {
   ...
   var _op = {};
   var withDimensionsS = F3(function (widthSignal,
   heightSignal,
   layout) {
      var _p0 = layout;
      if (_p0.ctor === "Static") {
            ...
            A3($Signal.map2,
            F2(function (x,y) {
               return {dimensions: {ctor: "_Tuple2",_0: x,_1: y}};
            }),
            widthSignal,
            heightSignal));
         } else {
            return _p0._0(A3($Signal.map2,
            F2(function (x,y) {
               return {dimensions: {ctor: "_Tuple2",_0: x,_1: y}};
            }),
            widthSignal,
   ...
   var fillscreen = A2(withDimensionsS,
   $Window.width,
   $Window.height);
   var withDimensions = F3(function (width,height,layout) {
      var _p1 = layout;
      if (_p1.ctor === "Static") {
            return $Signal.constant(_p1._0({dimensions: {ctor: "_Tuple2"
                                                        ,_0: width
                                                        ,_1: height}}));
         } else {
            return _p1._0($Signal.constant({dimensions: {ctor: "_Tuple2"
                                                        ,_0: width
                                                        ,_1: height}}));
         }
   });
   ...
   var adjustS = F3(function (fc,fe,layout) {
      var _p2 = layout;
      if (_p2.ctor === "Static") {
            return Dynamic(function (_p3) {
               return fe(A2($Signal.map,_p2._0,fc(_p3)));
            });
         } else {
            return Dynamic(function (_p4) {
               return fe(_p2._0(fc(_p4)));
            });
         }
   });
   var mapS = adjustS($Basics.identity);
   var containS = F2(function (positionSignal,elementSignal) {
      return Dynamic(function (configSignal) {
         return A4($Signal.map3,
         F3(function (config,position,element) {
            var _p5 = config.dimensions;
   ...
   var adjust = F3(function (fc,fe,layout) {
      var _p6 = layout;
      if (_p6.ctor === "Static") {
            return Static(function (_p7) {
               return fe(_p6._0(fc(_p7)));
            });
         } else {
            return Dynamic(function (_p8) {
               return A2($Signal.map,fe,_p6._0(A2($Signal.map,fc,_p8)));
            });
         }
   });
   var map = adjust($Basics.identity);
   var contain = F2(function (position,element) {
   ...
   var inset = F3(function (dx,dy,layout) {
      var makeContainer = F2(function (config,element) {
      ...
      var makeConfig = function (config) {
         ...
         return {dimensions: {ctor: "_Tuple2"
                             ,_0: A2($Basics.max,0,_p11._0 - 2 * dx)
                             ,_1: A2($Basics.max,0,_p11._1 - 2 * dy)}};
      };
      var _p12 = layout;
      if (_p12.ctor === "Static") {
            return Static(function (config) {
               return A2(makeContainer,config,_p12._0(makeConfig(config)));
            });
         } else {
            return Dynamic(function (configSignal) {
               ...
               makeContainer,
               configSignal,
               _p12._0(A2($Signal.map,makeConfig,configSignal)));
            });
         }
   });
   var placeholder = function (string) {
      ...
      1,
      A2(map,
      $Graphics$Element.color($Color.green),
      A2(contain,
      $Graphics$Element.middle,
      $Graphics$Element.show(string))));
   };
...
Elm.Main.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var main = $Layout.fillscreen($Layout.placeholder("hi!"));
