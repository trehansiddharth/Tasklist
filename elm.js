...
Elm.Reactive = Elm.Reactive || {};
Elm.Reactive.make = function (_elm) {
   "use strict";
   _elm.Reactive = _elm.Reactive || {};
   if (_elm.Reactive.values) return _elm.Reactive.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var getStatic = function (x) {
      var _p1 = x;
      if (_p1.ctor === "Static") {
            return _p1._0;
         } else {
            return _U.crashCase("Reactive",
            {start: {line: 13,column: 15},end: {line: 15,column: 88}},
            _p1)("You ran getStatic on a dynamic reactive value, not good");
         }
   };
   ...
   var apply = F2(function (rf,rx) {
      ...
      if (_p3.ctor === "Static") {
            ...
            var _p4 = rx;
            if (_p4.ctor === "Static") {
                  return Static(_p5(_p4._0));
               } else {
                  return Dynamic(A2($Signal.map,
                  function (x$) {
                     return _p5(x$);
                  },
                  _p4._0));
